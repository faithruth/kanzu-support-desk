...
if ( ! class_exists( 'Kanzu_Support_Desk' ) ) :
	...
	final class Kanzu_Support_Desk {
		 ...
		 * @param Object $updated_settings The settings object.
		 */
		 ...
		 * @since 2.2.12
		 *
		 * @param Object $ticket_reply  The ticket reply object.
		 */
		 ...
		 * @since 1.7.0
		 */
		public function output_ksd_signature( $tkt_id, $append_logo = false ) {
			$suffix        = '';
		 ...
		 * 
		 */
		private function get_url( $url, $tkt_id ){
			if ( empty( $url ) ) {
		 ...
		 *
		 * @param Array $new_ticket_activity The new activity to insert. Note that one of the keys must be post_parent and it should be a valid ID of a ksd_ticket.
