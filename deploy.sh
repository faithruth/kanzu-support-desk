...
CURRENTDIR=`pwd`
MAINFILE="kanzu-support-desk.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/kanzu-support-desk" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="kanzucode" # your svn username
