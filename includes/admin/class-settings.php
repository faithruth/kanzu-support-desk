...
use Kanzu\Ksd\Admin\User as ksd_user;
	...
	class Settings {
		...
		public function output_admin_menu_dashboard() {
			...
			if ( isset( $_GET['ksd-intro'] ) ) {
				...
				include_once KSD_PLUGIN_DIR . 'includes/admin/class-settings.php';
				$addon_settings      = new Settings();
		...
		public function generate_addon_settings_html() {
			...
			return array(
				'tab_html' => $tab_list_html,
				'div_html' => $tab_div_html,
			);
		}
