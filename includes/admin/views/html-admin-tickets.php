...
if ( isset($_GET['ticket']) ):  
	...
	<div id="ticket-tabs" class="admin-ksd-tickets-container">
		<ul>
                    <li><a href="#tickets-tab-1"><?php _e('My unresolved','kanzu-support-desk'); ?><span></span></a>|</li>
			<li><a href="#tickets-tab-2"><?php _e('All','kanzu-support-desk'); ?><span></span></a>|</li>
			<li><a href="#tickets-tab-3"><?php _e('Unassigned','kanzu-support-desk'); ?><span></span></a>|</li>
			<li><a href="#tickets-tab-4"><?php _e('Recently updated','kanzu-support-desk'); ?><span></span></a>|</li>
			<li><a href="#tickets-tab-5"><?php _e('Recently resolved','kanzu-support-desk'); ?><span></span></a>|</li>
			<li><a href="#tickets-tab-6"><?php _e('Resolved','kanzu-support-desk'); ?><span></span></a></li>
		</ul>
