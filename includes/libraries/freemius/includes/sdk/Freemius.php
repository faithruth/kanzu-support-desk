...
class Freemius_Api extends Freemius_Api_Base {
	...
	private static function MakeStaticRequest(
		...
		if ( is_null( $decoded ) ) {
			...
			} elseif ( preg_match( '/Access control configuration prevents your request from being allowed at this time. Please contact your service provider if you feel this is incorrect./', $result ) &&
