...
if ( ! class_exists( 'Uninstaller' ) ) :
	...
	class Uninstaller {
		...
		public function send_uninstall_email() {
			...
			$message .= __(
				'We\'ve noticed that you installed the plugin and then uninstalled it fairly quickly.
	It seems something did not quite add up. Sorry about that. Would you be so kind to tell us what was the reason for uninstalling the plugin? We want to make sure we fix that for our future users.',
				'kanzu-support-desk'
			) . '\r\n';
