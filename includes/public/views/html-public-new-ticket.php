    ...
    <form method="POST" class="ksd-new-ticket-public ksd-form-hidden-tab-form">
        ...
        ?>
            ...
            <select class="ksd-severity" name="ksd_tkt_severity" >
                <option selected="selected" disabled="disabled"><?php _e( 'Severity', 'kanzu-sipport-desk' ); ?></option>
        ...
        <li class="ksd-pdt-category" >
            ...
            <option selected="selected" disabled="disabled"><?php _e( 'Category', 'kanzu-sipport-desk' ); ?></option>    
            <?php
