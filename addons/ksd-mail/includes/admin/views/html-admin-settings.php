...
<h3><?php _e("Mail","ksd-mail"); ?> </h3>
                <div>
                   <div class="setting">
                       ...
                       <input type="text" value="<?php echo $mail_settings['ksd_mail_server']; ?>" size="30" name="ksd_mail[ksd_mail_server]" />
                   </div>
                   <div class="setting">
                       <label for="ksd_mail_account"><?php _e("Support Email Address","kanzu-support-desk"); ?></label>
                       <input type="text" value="<?php echo $mail_settings['ksd_mail_account']; ?>" size="30" name="ksd_mail[ksd_mail_account]" />
                   </div>
                   <div class="setting">
                       <label for="ksd_mail_password"><?php _e("Password","kanzu-support-desk"); ?></label>
                       <input type="password"  size="30" name="ksd_mail[ksd_mail_password]" value="<?php echo $mail_settings['ksd_mail_password']; ?>"/>
                   </div>
                   <div class="setting">
                       <label for="ksd_mail_protocol"><?php _e("Protocol","kanzu-support-desk"); ?></label>
                       <select name="ksd_mail[ksd_mail_protocol]">
                       ...
                       <input type="text" value="<?php echo $mail_settings['ksd_mail_port']; ?>" size="30" name="ksd_mail[ksd_mail_port]" />
                   </div> 
                   <div class="setting">
                       ...
                       <input type="text" value="<?php echo $mail_settings['ksd_mail_mailbox']; ?>" size="30" name="ksd_mail[ksd_mail_mailbox]" />
                   </div>
                  <div class="setting">
                       ...
                       <input name="ksd_mail[ksd_mail_check_freq]"  type="text" size="30" value="<?php echo $mail_settings['ksd_mail_check_freq']; ?>"  />
                   </div> 
                   <div class="setting">
                       ...
                       <input name="ksd_mail[ksd_mail_validate_certificate]"  type="checkbox" <?php checked( $mail_settings['ksd_mail_validate_certificate'], "yes" ) ?> value="yes"  />
                   </div> 
                   <div class="setting">
                       ...
                       <input name="ksd_mail[ksd_mail_useSSL]"  type="checkbox" <?php checked( $mail_settings['ksd_mail_useSSL'], "yes" ) ?> value="yes"  />
                   </div> 
                </div>
