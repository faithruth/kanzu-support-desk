<div id="ksd-intro-one" class="wrap about-wrap">
    ...
    <?php       printf( '%1$s %2$s,<br />%3$s<span class="ksd-blue-bold">%4$s</span>.%5$s',
            __('Hi','kanzu-support-desk'),
            $current_user->display_name,
            __( 'Thanks for choosing ', 'kanzu-support-desk'),
            __( ' Kanzu Support Desk (KSD)', 'kanzu-support-desk'),
            __( 'We built it to make giving great, personal customer support simpler for you. We focused a lot on simplicity, with the goal of making it as simple to use as WordPress itself.  To get you started, we have added a guided tour. First, you will create a ticket...', 'kanzu-support-desk')
                    );
        ?>            
