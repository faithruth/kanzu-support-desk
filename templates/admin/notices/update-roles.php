...
<div class='update-nag'>
	...
	<p class="submit">
		...
		<a class="button-secondary skip" href="
		<?php
		echo esc_url(
			wp_nonce_url(
				add_query_arg(
					array(
						'ksd_action' => 'ksd_hide_notices',
						'ksd_notice' => 'update-roles',
					)
				),
				'ksd_hide_notices_nonce',
				'_ksd_notice_nonce'
			)
		);
		?>
		"><?php esc_html_e( 'Hide This Notice', 'kanzu-support-desk' ); ?></a>
	</p>
</div>
