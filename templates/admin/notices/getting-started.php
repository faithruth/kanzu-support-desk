...
<div id="ksd-gs-tabs">
	...
	<div id="ksd-gs-tabs-0">
		...
		<div class="ksd-gs-kc-signature">
			...
			<?php esc_attr_x( 'Team', 'company team e.g. WordPress team', 'kanzu-support-desk' ); ?> Kanzu Code</p>
	...
	<div id="ksd-gs-tabs-1">
		...
		<ul class="ksd-gs-user-roles">
			<li><strong><?php esc_attr_x( 'KSD Customer', 'WordPress role for customers', 'kanzu-support-desk' ); ?>:</strong><?php esc_html_e( 'This is the default role assigned to everyone who submits a ticket. It is the equivalent of the', 'kanzu-support-desk' ); ?> <a href="https://codex.wordpress.org/Roles_and_Capabilities#Subscriber" target="_blank"><?php esc_html_e( 'WordPress subscriber role', 'kanzu-support-desk' ); ?></a></li>
			<li><strong><?php esc_attr_x( 'KSD Agent', 'WordPress role for helpdesk staff', 'kanzu-support-desk' ); ?></strong><?php esc_html_e( 'This is a member of your team who can view, reply and make all changes to tickets apart from deleting them.', 'kanzu-support-desk' ); ?></li>
			<li><strong><?php esc_attr_x( 'KSD Supervisor', 'WordPress role for helpdesk staff', 'kanzu-support-desk' ); ?></strong> <?php esc_html_e( 'This role has all the rights of a KSD Agent but also, they can delete tickets', 'kanzu-support-desk' ); ?></li>
		</ul>
