		...
		<div id="ksd-merge-selector">
			...
			<div class="ksd-merge-ticket-merge-wrap hidden">
				...
				<div class="ksd-merge-ticket-merge-button-wraper">
					<button type="button" class="button button-large" id="ksd-merge-ticket-merge-button"><?php esc_html_e( 'Merge', 'kanzu-support-desk' ); ?></button>
				</div>
			</div>
			<div class="submitbox">
				<div id="ksd-merge-ticket-select" class="hidden">
					<em><?php esc_html_e( 'A merge cannot be undone', 'kanzu-support-desk' ); ?></em>
					<div class="confirm-merge-wrapper">
						<input type="submit" value="<?php esc_attresc_html_e( 'Confirm Merge', 'kanzu-support-desk' ); ?>" class="button button-primary" id="ksd-merge-ticket-confirm" name="ksd-merge-ticket-confirm">
						<input type="button" class="button button-large" id="ksd-merge-cancel" value="<?php esc_attresc_html_e( 'Cancel', 'kanzu-support-desk' ); ?>"/>
					</div>
				</div>
			</div>
			<div id="ksd-merge-final-response" class="empty"></div>
			<div id="ksd-merge-search-panel">
				<span class="search-label"><?php esc_html_e( 'Search for ticket to merge', 'kanzu-support-desk' ); ?></span>
				<input type="text" id="ksd-merge-ticket-search-text" name="ksd-merge-ticket-search" placeholder="<?php esc_html_e( 'Search...', 'kanzu-support-desk' ); ?>" /><button class="button button-small" id="ksd-merge-ticket-search"><?php esc_html_e( 'Search', 'kanzu-support-desk' ); ?></button>
			</div>
			<div id="ksd-merge-most-recent-results" class="query-results" tabindex="0">
				...
				<ul class="ksd-merge-tickets-list">
					<li>
						<em class="query-notice-default"><?php esc_html_e( 'No search term specified. Search for a ticket to merge', 'kanzu-support-desk' ); ?></em>
						<em class="query-notice-hint screen-reader-text"><?php esc_html_e( 'Search or use up and down arrow keys to select an item.', 'kanzu-support-desk' ); ?></em>
					</li>
				</ul>
			</div>
		</div>
