    ...
    <form id="ksd-merge-ticket" tabindex="-1">
        ...
        <div id="ksd-merge-selector">
            <div class="ksd-merge-ticket-merge-wrap hidden">
                <p class="ksd-merge-how-to" id="ksd-merge-existing-content"><?php _e( 'Merge the following ticket into the current ticket', 'kanzu-support-desk' ); ?></p>
                <span id="ksd-merge-merge-ticket-title"></span> 
                <input class="ksd-merge-merge-ticket-id" name="ksd-merge-merge-ticket-id" type="hidden" value="0" />
                <button type="button" class="button button-large" id="ksd-merge-ticket-complete"><?php _e( 'Merge', 'kanzu-support-desk'  ); ?></button>
            </div>            
            ...
            <div class="submitbox">
                <div id="ksd-merge-ticket-select" class="hidden">
                    ...
                    <input type="submit" value="<?php esc_attr_e( 'Confirm Merge', 'kanzu-support-desk'  ); ?>" class="button button-primary" id="ksd-merge-ticket-submit" name="ksd-merge-ticket-submit">
            ...
            <div id="ksd-merge-search-panel">
                ...
                <input type="text" id="ksd-merge-ticket-search-text" name="ksd-merge-ticket-search"/><button class="button button-small" id="ksd-merge-ticket-search"><?php _e( 'Search', 'kanzu-support-desk' );?></button>
            </div>
