...
<div id="ksd-messages-metabox">
	...
	<div id="edit-ticket-tabs">
		<ul class="edit-ticket-options">
			<li><a href="#reply_ticket"><?php esc_html_e( 'Reply', 'kanzu-support-desk' ); ?></a></li>
			<li><a href="#update_private_note"><?php esc_html_e( 'Reply to staff only', 'kanzu-support-desk' ); ?></a></li>
		</ul>
		<div class="edit-ticket-description" id="reply_ticket">
			<input type="text" value="<?php esc_html_e( 'CC', 'kanzu-support-desk' ); ?>" maxlength="255" name="ksd_tkt_cc" label="<?php esc_html_e( 'CC', 'kanzu-support-desk' ); ?>" class="ksd-cc" minlength="2" style="display:none;" data-rule-ccRule />
			<?php
			wp_editor(
				'',
				'ksd_ticket_reply',
		...
		<div id="update_private_note" class="single-ticket-textarea">
			<?php
			$private_note_settings = array( 'textarea_rows' => 5 );
	...
	<div class="ksd-reply-submit-wrapper">
		...
		<input type="submit" value="<?php esc_html_e( 'Send', 'kanzu-support-desk' ); ?>" name="ksd_reply_ticket" id="ksd-reply-ticket-submit" class="button button-primary button-large ksd-submit"/>
	</div>
</div>
