...
<div class="ksd-misc-severity misc-pub-section">
	<span><?php esc_html_e( 'Severity: ', 'kanzu-support-desk' ); ?></span>
	<?php
	$the_severity     = get_post_meta( $post->ID, '_ksd_tkt_info_severity', true );
	...
	<a href="#severity" class="edit-severity"><?php esc_html_e( 'Edit', 'kanzu-support-desk' ); ?></a>
	<div class="ksd_tkt_info_severity ksd_tkt_info_wrapper hidden">
		...
		<a class="save-severity button" href="#severity"><?php esc_html_e( 'OK', 'kanzu-support-desk' ); ?></a>
		<a class="cancel-severity button-cancel" href="#severity"><?php esc_html_e( 'Cancel', 'kanzu-support-desk' ); ?></a>
	</div>
</div>
<div class="ksd-misc-assign-to misc-pub-section">
	...
	<a href="#assign-to" class="edit-assign-to"><?php esc_html_e( 'Edit', 'kanzu-support-desk' ); ?></a>
	<div class="ksd_tkt_info_assigned_to ksd_tkt_info_wrapper hidden">
		...
		<a class="save-assign-to button" href="#assign-to"><?php esc_html_e( 'OK', 'kanzu-support-desk' ); ?></a>
		<a class="cancel-assign-to button-cancel" href="#assign-to"><?php esc_html_e( 'Cancel', 'kanzu-support-desk' ); ?></a>
	</div>
</div>
<?php
...
if ( ! empty( $ksd_tkt_referer ) ) :
	...
	<div class="ksd-misc-referer misc-pub-section">
		<span><?php esc_html_e( 'Submitted From', 'kanzu-support-desk' ); ?>:</span>
