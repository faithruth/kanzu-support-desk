...
<form id="ksd-reply">
	...
	<input type="submit" value="<?php esc_html_e( 'Send', 'kanzu-support-desk' ); ?>" name="ksd_reply_ticket" id="ksd-public-reply-submit" class="button button-primary button-large ksd-submit"/>
</form>
